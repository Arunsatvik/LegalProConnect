            ...
            <div>
              <div className=" lg:w-[570px]">
                <h1 className="text-headingColor text-[36px] leading-[46px] md:text-[60px] md:leading-[70px] font-[800] ">
                  We connect clients with expert legal services.
                </h1>
                <p className="text__para">
                  At LegalProConnect, we facilitate seamless access to a wide range of legal services,
                   ensuring you receive the expert guidance needed to secure your future.
                    Are you ready to take the first step towards a legally protected and worry-free tomorrow?
                </p>
        ...
        <div className="container ">
          <div className="lg:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              World-class suggestions for everyone.
            </p>
          </div>
            ...
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  World-class suggestions for everyone. Our professionals offers
                  unmatched, expert legal care.
                </p>
          ...
          <div className="flex justify-between items-center flex-col lg:flex-row">
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  3. View our physicians who are accepting new clients, use the
