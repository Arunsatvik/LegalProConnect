        ...
        <div className="mb-5">
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              >
                <option value="">Select</option>
                <option value="Family and Personal Law">Family and Personal Law</option>
                <option value="Business and Corporate Law">Business and Corporate Law</option>
                <option value="Criminal Defense and Real Estate Law">Criminal Defense and Real Estate Law</option>
              </select>
            </div>
