...
// import lawyerImg from "../../assets/images/lawyer-img02.png";
          ...
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px] ">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-8">
                {tab === "overview" && (
                  <div>
                    <div className="flex gap-5 items-center mb-10">
                      <figure >
                        <img src={lawyerData.photo} alt="" className="w-full" style={{ width: '230px', height: '300px' }} />
                      </figure>
                      <div>
                ...
                {tab === "appointments" && (
                  <Appointments appointments={lawyerData.appointments} />
                )}
              </div>
            </div>
          </div>
