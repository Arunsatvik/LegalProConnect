...
// import userProfile from "../../assets/images/lawyer-img01.png";
              ...
              <div className="flex items-center justify-center">
                <figure className="w-[100px] h-[100px] rounded-full border-2 border-solid border-[#0067FF]">
                  <img
                    ...
                    alt=""
                    style={{
                      width: '100px',   // Set the width and height to make it a circle
                      height: '99px',
                      borderRadius: '100%',  // Use borderRadius to make it round
                    }}
