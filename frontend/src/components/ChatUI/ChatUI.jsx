...
const ChatUI = () => {
    ...
    const role = "Your Role: You were hired as part of LegalProConnect AI team that specializes in providing legal services to commercial companies and individuals. As part of the legal professional's day-to-day job, you need to study US laws to provide appropriate legal suggestions to benefit the clients.\n";
    ...
    const handleSendClick = async () => {
        ...
        const apiUrl = `http://ec2-54-82-28-3.compute-1.amazonaws.com:8080/bot/chat?prompt=${encodeURIComponent(textToSendRef.current)}`;
